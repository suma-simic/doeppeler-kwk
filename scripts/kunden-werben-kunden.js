<div id="zf_div_GOs2QL2urIF5rgpJtvcgsilR7CgKws9lCAiYUMdMpQA"></div>
...
(function() {
  try{
    ...
    // ---------------------------------------------------------
    var ifrmSrc ="https://forms.zohopublic.eu/doeppelergmbh1/form/KundenempfehlungHomepage1/formperma/GOs2QL2urIF5rgpJtvcgsilR7CgKws9lCAiYUMdMpQA?zf_rszfm=1&utm_source=homepage&utm_medium=form1_empfehler&utm_campaign=kunden_werben_kunden";
    ...
    var d = document.getElementById("zf_div_GOs2QL2urIF5rgpJtvcgsilR7CgKws9lCAiYUMdMpQA");
    d.innerHTML = "";
    d.appendChild(f);
    ...
    window.addEventListener("message", function (event){
      ...
      if( evntData && evntData.constructor == String ){
        ...
        if ( zf_ifrm_data.length == 2 || zf_ifrm_data.length == 3 ) {
          ...
          var iframe = document.getElementById("zf_div_GOs2QL2urIF5rgpJtvcgsilR7CgKws9lCAiYUMdMpQA").getElementsByTagName("iframe")[0];
