...
(function () {
  ...
  function init() {
    ...
    var targetBase = "https://www.doeppeler.com/unverbindliche-anfrage/";
    ...
    var subject = "Meine Empfehlung: Döppeler GmbH";
    var EOL = "\r\n";

    var emailBody = [
      "Hallo,",
      "",
      "kurzer Tipp: Döppeler GmbH – ich bin mit dem Insektenschutz sehr zufrieden.",
      "",
